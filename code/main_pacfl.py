...
for idx in range(args.num_users):
    ...
    clients.append(Client_ClusterFL(idx, copy.deepcopy(users_model[idx]), args.local_bs, args.local_ep,
                                    args.lr, args.momentum, args.device, args.dp_clip, args.dp_epsilon, args.dp_delta,
                                    args.rounds, train_dl_local, test_dl_local))
...
for iteration in range(args.rounds):
    ...
    for idx in idxs_users:
        ...
        # if iteration + 1 == 1:
        #   rel = Distance(args, clients, clusters)
        rel = Distance(args, clients, clusters)
